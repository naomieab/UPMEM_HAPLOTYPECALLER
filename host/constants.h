...
#define MAX_REGIONS_PER_DPU 3// Has to be an odd number
...
#define NR_REGIONS 6000 //Maximum number of regions which can be sent in a single round (we send by chunk to dpus)
