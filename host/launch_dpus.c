...
dpu_error_t run_rank(struct dpu_set_t set, uint32_t rank_id, void* arg) {
	...
	DPU_ASSERT(dpu_push_xfer(set, DPU_XFER_TO_DPU, "mram_reads_len", 0, MAX_READ_NUM * sizeof(uint64_t), DPU_XFER_ASYNC));
	...
	DPU_ASSERT(dpu_push_xfer(set, DPU_XFER_TO_DPU, "mram_haplotypes_len", 0, MAX_HAPLOTYPE_NUM * sizeof(uint64_t), DPU_XFER_ASYNC));
	...
	DPU_ASSERT(dpu_push_xfer(set, DPU_XFER_TO_DPU, "mram_reads_array", 0, MAX_READ_NUM * MAX_READ_LENGTH * sizeof(char), DPU_XFER_ASYNC));
	...
	DPU_ASSERT(dpu_push_xfer(set, DPU_XFER_TO_DPU, "mram_matchToIndelArray", 0, MAX_READ_NUM * MAX_READ_LENGTH * sizeof(int32_t), DPU_XFER_ASYNC));
	...
	DPU_ASSERT(dpu_push_xfer(set, DPU_XFER_TO_DPU, "mram_priors", 0, 2 * MAX_READ_NUM * MAX_READ_LENGTH * sizeof(int32_t), DPU_XFER_ASYNC));
	...
	DPU_ASSERT(dpu_push_xfer(set, DPU_XFER_TO_DPU, "mram_haplotypes_array", 0, MAX_HAPLOTYPE_NUM * MAX_HAPLOTYPE_LENGTH * sizeof(char), DPU_XFER_ASYNC));
	...
	DPU_ASSERT(dpu_push_xfer(set, DPU_XFER_TO_DPU, "mram_haplotypes_val", 0, MAX_HAPLOTYPE_NUM * sizeof(uint64_t), DPU_XFER_ASYNC));
	...
	DPU_ASSERT(dpu_push_xfer(set, DPU_XFER_TO_DPU, "nr_haplotypes", 0, sizeof(uint64_t), DPU_XFER_ASYNC));
	...
	DPU_ASSERT(dpu_push_xfer(set, DPU_XFER_TO_DPU, "nr_reads", 0, sizeof(uint64_t), DPU_XFER_ASYNC));
	...
	DPU_ASSERT(dpu_push_xfer(set, DPU_XFER_TO_DPU, "read_region_starts", 0, (MAX_REGIONS_PER_DPU+1) * sizeof(uint32_t), DPU_XFER_ASYNC));
	...
	DPU_ASSERT(dpu_push_xfer(set, DPU_XFER_TO_DPU, "haplotype_region_starts", 0, (MAX_REGIONS_PER_DPU+1) * sizeof(uint32_t), DPU_XFER_ASYNC));
	...
	DPU_ASSERT(dpu_push_xfer(set, DPU_XFER_FROM_DPU, "likelihoods", 0, MAX_HAPLOTYPE_NUM * MAX_READ_NUM * sizeof(int64_t), DPU_XFER_ASYNC));
	...
	DPU_ASSERT(dpu_push_xfer(set, DPU_XFER_FROM_DPU, "nb_cycles", 0, sizeof(uint64_t), DPU_XFER_ASYNC));
	...
	// Callback itself
	DPU_ASSERT(dpu_callback(set, run_rank, NULL, DPU_CALLBACK_ASYNC | DPU_CALLBACK_NONBLOCKING));
	return DPU_OK;
}
...
void launch_all_ranks() {
	...
	DPU_ASSERT(dpu_callback(set_all_dpus, run_rank, NULL, DPU_CALLBACK_ASYNC | DPU_CALLBACK_NONBLOCKING));
}
